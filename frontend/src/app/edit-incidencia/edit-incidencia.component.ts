import {
  ...
  export class EditIncidenciaComponent implements OnInit, AfterViewInit {
    ...
    // Reemplazar el método capturarFoto() con esta nueva implementación
    capturarFoto(): void {
    ...
    // Modificar el método confirmarEdicion() y actualizarIncidencia()
    confirmarEdicion(): void {
      ...
      // Primero actualizar la incidencia
    ...
    actualizarIncidencia(): void {
      this.inspectorService.actualizarIncidencia(this.incidencia).subscribe(
        (res) => {
          if (res == "ok") {
            // Si hay una nueva foto, subirla con el ID correcto
            if (this.selectedFile) {
              this.subirFotoConId(this.incidencia.id)
            } else {
              this.actualizarOk()
            }
          } else {
    ...
    // Añadir el nuevo método subirFotoConId() y reemplazar el método subirFoto()
